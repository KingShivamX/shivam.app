...
const Socials = () => {
    ...
    return (
        ...
        >
            {/* Glassmorphism Container for Social Icons */}
            <motion.div
                        ...
                        >
                            {social.isExternal ? (
                                ...
                                >
                                    {/* Glow effect */}
                                    <motion.div
                                        className={`absolute -inset-2 bg-gradient-to-r ${social.gradient} rounded-xl opacity-0 group-hover:opacity-20 blur-lg transition-all duration-200`}
                                    />

                                    <motion.div
                                        className={`relative flex items-center justify-center p-2 sm:p-3 rounded-xl bg-gradient-to-br ${social.gradient}/10 border border-white/20 transition-all duration-200`}
                                        whileHover={{
